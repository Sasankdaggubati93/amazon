...
Array.prototype.myFilter = function (cb) {
  ...
  for (var i = 0; i < context.length; i++) {
    if (cb(context[i], i, context)) result.push(context[i]);
  }
...
Function.prototype.myBind = function (context) {
  ...
  var newContext = this;
  return function () {
    newContext.apply(context, args.concat.apply(args, arguments));
  };
};
...
},{}],"Searchbar/main.js":[function(require,module,exports) {
"use strict";

var _utils = require("../utils");

var userCardTemplate = document.querySelector("[data-user-template]");
var userCardContainer = document.querySelector("[data-user-card-container]");
var users = [];
...
searchBar.addEventListener('input', (0, _utils.debouncing)(handleChange, 300));

function handleChange(e) {
  var searchText = e.target.value.toLowerCase();
  users.forEach(function (user) {
    var visible = user.name.toLowerCase().includes(searchText) || user.email.toLowerCase().includes(searchText);
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","Searchbar/main.js"], null)
//# sourceMappingURL=/main.d6bdfad6.js.map